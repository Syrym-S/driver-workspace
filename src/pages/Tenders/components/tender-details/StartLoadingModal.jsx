...
export function StartLoadingModal({
    open,
    isSubmitting = false,
    error = '',
    onClose,
    ...
    return (
        ...
        >
            <DialogTitle>Начало загрузки</DialogTitle>

            <DialogContent>
                <Stack spacing={2}>
                    <Typography color='text.secondary' sx={{ fontSize: 14 }}>
                        Прикрепите документы, фото или видео, которые
                        подтверждают начало загрузки груза.
                    </Typography>
...
function StartLoadingFileCard({ document, onDelete, isDeleting = false }) {
    return (
        <Box
            sx={{
                p: 1.5,
